...
const events = [
  {
    ...
    overview: "Welcome to Null Core, a Jeopardy-style cybersecurity competition where participants solve a series of challenges designed to test their technical skills, creativity, and problem-solving abilities.",
  ...
  },
  {
    ...
    overview: "A cybersecurity CTF-style event where teams hunt vulnerabilities, exploit logic, and solve puzzles.",
    format: "Teams of 2-3 participants.\nRound 1 (Find the Flag): Score-based CTF questions.\nRound 2 (Live Hack): Attack a simulated system under time pressure.",
    rules: [
  ...
  },
  {
    ...
    overview: "Beat Overflow is a time-bound, creative coding event where teams develop innovative web or mobile applications based on a given problem statement. Participants are encouraged to blend logic, design, and AI tools to build impactful solutions.",
    format: "Teams of exactly 2 members from the same institution.\nProblem statement is revealed at the start.\nParticipants may build a web or mobile app using any tech stack.\nAI tools can be used as part of the development workflow.",
    rules: [
  ...
  },
  {
    ...
    overview: "Push the limits of imagination and tech — create AR/VR concepts or solve challenges in an immersive environment.",
    format: "Teams of up to 3 members.\nRound 1: Conceptual presentation (design + tech pitch).\nRound 2: Rapid prototyping with Unity/WebXR tools.",
    rules: [
  ...
  },
  {
    ...
    overview: "A platform for students to showcase their innovative ideas, research, and prototypes bridging academic concepts with real-world applications.",
    format: "Individual or team of 2.\nPresent a paper/project using slides and/or a live demo.\nJudged on clarity, innovation, and practicality.",
    rules: [

  ...
  return (
    <div className="flex flex-col items-center px-10 md:px-20 lg:px-32 py-16 w-full">
      <div className="w-full font-funnel text-blue-50 flex flex-col items-center gap-8">
        ...
        <h2 className="text-lg text-center">BROCHURES</h2>
        <hr className="border-t border-white/20 w-full" />

        {/* Carousel */}
        <div
          className="relative w-full overflow-hidden rounded-xl h-[400px] md:h-[500px] lg:h-[550px]"
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2 px-5 py-2 bg-white/5 hover:bg-white/20 border border-white/20 text-white/70 rounded-xl text-lg font-medium transition-all duration-300"
        >
